...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !WABinary_1.isJidNewsletter(jid)) {
        ...
        // Perbaikan: Pastikan quotedMsg memiliki properti yang sesuai dengan msgType
        if (quotedMsg && quotedMsg[msgType]) {
            ...
            // Jika tidak ada konten yang valid, set quoted menjadi undefined
